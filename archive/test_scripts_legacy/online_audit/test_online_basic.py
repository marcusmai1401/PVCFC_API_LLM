...
class OnlineBasicTester:
    ...
    def test_server_health(self):
        ...
        try:
            ...
            self.results["server_health"] = {"status": "FAIL", "error": str(e)}
    ...
    def test_schema_validation(self):
        ...
        try:
                ...
                if not missing_fields:
                    ...
                    if citations:
                        ...
                        missing_citation_fields = [
                            f for f in citation_fields if f not in first_citation
                        ]
                        ...
                        if not missing_citation_fields:
                            ...
                            logger.warning(
                                f"  ⚠ Missing citation fields: {missing_citation_fields}"
                            )
            ...
            self.results["schema_validation"] = {"status": "FAIL", "error": str(e)}
    ...
    def test_basic_vi_query(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.findings.append(
                    {"check": "vi_query", "status": "PASS", "latency_ms": latency}
                )
            else:
                logger.error(f"✗ Request failed: {response.status_code}")
                self.results["basic_vi_query"] = {
            ...
            self.results["basic_vi_query"] = {"status": "FAIL", "error": str(e)}
    ...
    def test_basic_en_query(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.findings.append(
                    {"check": "en_query", "status": "PASS", "latency_ms": latency}
                )
            else:
                logger.error(f"✗ Request failed: {response.status_code}")
                self.results["basic_en_query"] = {
            ...
            self.results["basic_en_query"] = {"status": "FAIL", "error": str(e)}

    def test_error_empty_query(self):
        """Test error handling for empty query"""
        try:
            payload = {"query": "", "language": "vi", "max_context": 8}  # Empty query
            ...
            self.results["error_empty_query"] = {"status": "FAIL", "error": str(e)}
    ...
    def test_error_invalid_params(self):
        ...
        try:
            ...
            if response.status_code == 422:
                ...
                self.findings.append(
                    {"check": "error_invalid_params", "status": "PASS"}
                )
            else:
            ...
            self.results["error_invalid_params"] = {"status": "FAIL", "error": str(e)}
    ...
    def _generate_report(self) -> Dict:
        ...
        report_path = (
            ...
            / "reports"
            / "test_results"
            / f"online_basic_test_{int(time.time())}.json"
        )
