...
pytestmark = pytest.mark.skipif(
    not redis_available, reason="Redis not available for distributed cache tests"
)


from app.core.cache_manager import CacheFactory, TTLCacheWrapper, get_cache
...
class TestCacheFactory:
    ...
    def test_get_distributed_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "app.core.cache_manager.settings.use_distributed_cache", True
        )
    ...
    def test_get_ttl_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "app.core.cache_manager.settings.use_distributed_cache", False
        )
