...
from app.rag.extractors.vector_extractor import TextBlock, VectorExtractor
...
def create_multipage_pdf(
    tmp_path: Path, pages_content: list, filename: str = "multipage.pdf"
) -> Path:
    """
...
class TestVectorExtractorStandalone:
    ...
    def test_simple_extraction(self, tmp_path):
        ...
        pdf_path = create_test_pdf(
            tmp_path, ["Hello World", "This is a test PDF", "Created with PyMuPDF"]
        )
    ...
    def test_hyphenation_handling(self, tmp_path):
        ...
        pdf_path = create_test_pdf(
            tmp_path, ["This is a hyphen-", "ated word example", "Another line here"]
        )
    ...
    def test_merge_nearby_blocks(self, tmp_path):
        ...
        pdf_path = create_test_pdf(
            tmp_path, ["First part", "Second part", "Third part"]
        )
    ...
    def test_custom_merge_threshold(self, tmp_path):
        ...
        assert (
            result_small["pages"][0]["block_count"]
            >= result_large["pages"][0]["block_count"]
        )
