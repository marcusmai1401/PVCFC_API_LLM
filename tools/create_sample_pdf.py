...
def create_simple_text_pdf(output_path: str = "data/raw/samples/sample_text.pdf"):
    ...
    page1.insert_text(
        (50, 50), "Technical Document Sample", fontsize=20, fontname="Helvetica-Bold"
    )

    # Add subtitle
    page1.insert_text(
        (50, 80), "Equipment Specification KT06101", fontsize=14, fontname="Helvetica"
    )
    ...
    # Add section heading
    page1.insert_text(
        (50, 180), "1. Operating Parameters", fontsize=14, fontname="Helvetica-Bold"
    )
    ...
    page2.insert_text(
        (50, 50), "2. Safety Instructions", fontsize=14, fontname="Helvetica-Bold"
    )
    ...
    page2.insert_text(
        (50, 180), "3. Maintenance Schedule", fontsize=14, fontname="Helvetica-Bold"
    )
...
def create_mixed_pdf(output_path: str = "data/raw/samples/sample_mixed.pdf"):
    ...
    page1.insert_text(
        (50, 50), "P&ID Diagram Reference", fontsize=16, fontname="Helvetica-Bold"
    )
    ...
    page2 = doc.new_page(width=595, height=842)
    page2.insert_text(
        (250, 400), "[Scanned Content]", fontsize=10, color=(0.5, 0.5, 0.5)
    )
...
def create_datasheet_pdf(output_path: str = "data/raw/samples/sample_datasheet.pdf"):
    ...
    page.insert_text(
        (50, 100), "Technical Specifications:", fontsize=12, fontname="Helvetica-Bold"
    )
    ...
    # Notes section
    page.insert_text((50, y_pos + 30), "Notes:", fontsize=12, fontname="Helvetica-Bold")
