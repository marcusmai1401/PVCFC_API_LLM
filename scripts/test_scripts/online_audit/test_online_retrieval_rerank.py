...
class RetrievalRerankTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "retrieval_details" in data and data["retrieval_details"]:
                    ...
                    if bm25_count > 0:
                        logger.info(f"  ✓ BM25 returned results (good for keyword query)")
                    else:
                ...
                self.results["keyword_query"] = {"status": "FAIL", "status_code": response.status_code}
        ...
        try:
            ...
            for k in test_values:
                ...
                if response.status_code == 200:
                    ...
                    logger.info(f"  k={k}: context={context_count}, citations={citations_count}")
    ...
    def test_retrieval_details(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                has_retrieval_details = "retrieval_details" in data and data["retrieval_details"]
                has_reranking_details = "reranking_details" in data and data["reranking_details"]
    ...
    def _generate_report(self) -> Dict:
        ...
        report_path = PROJECT_ROOT / "reports" / "test_results" / f"online_retrieval_test_{int(time.time())}.json"
        report_data = {
