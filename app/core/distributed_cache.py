...
class DistributedCache:
    ...
    def __init__(
        ...
        self.enable_compression = enable_compression or settings.cache_enable_compression
    ...
    def clear_namespace(self) -> int:
        ...
        try:
            ...
            if keys:
                ...
                logger.warning(f"Cleared {deleted} keys from namespace {self.namespace_prefix}")
                return deleted
            return 0
