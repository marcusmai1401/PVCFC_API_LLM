...
# Import IEEE citation formatter from shared utility
try:
    ...
    if st.session_state.query_results:
        ...
        with tab1:
            ...
            if citations:
                ...
                if use_ieee and "ieee_citation_list" in locals():
                    # IEEE-style references - simplified format
                    # Format: [1] filename.pdf, trang X
                    refs_html = render_ieee_references(
                        ieee_citation_list, language="vi"
                    )
